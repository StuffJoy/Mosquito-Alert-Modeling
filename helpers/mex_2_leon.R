...
target_country_iso3 = "MEX"
target_country_iso2 = "MX"
target_level = 2
target_city = "León"
android_start_date = as.POSIXct(strptime('2014-06-14 00:00:00.000000+0000', format="%Y-%m-%d %H:%M:%S%OS%z", tz="gmt"))

raw_pop_density = "data/population/Mexico_Guanajuato_Leon_WorldPop_2020_population_100m.tif"
raw_ndvi = "data/ndvi/Mexico_Guanajuato_Leon_NDVI_2024-01-31_2024-12-31.tif"
raw_landcover = "data/landcover/Mexico_Guanajuato_Leon_WorldCover_2021.tif"
